...
public class MainController {
        ...
        String[] fileNames = {"schedule-view.fxml", "settings-view.fxml", "specials-view.fxml", "teacher-view2.fxml"};
        @FXML
        public void initialize () {
       changeIndex(fileNames, 0);
    }
        @FXML
        private void handleHomeB (ActionEvent event){
        changeIndex(fileNames, 0);
    }
        @FXML
        private void handleScheduleB (ActionEvent event){
        changeIndex(fileNames, 1);
    }
        @FXML
        private void handleSpecialsB (ActionEvent event){
        changeIndex(fileNames, 2);
    }
        @FXML
        private void handleTeachersB (ActionEvent event){
        changeIndex(fileNames, 3);
    }
        @FXML
        private void handleSettingsB (ActionEvent event){
        changeIndex(fileNames, 4);
    }
